...
const mockIngredients: RecipeIngredientDetails[] = [
    { id: 1, name: "Salmon",  image: "http://localhost:3845/assets/salmon.png",  RecipeIngredient: { quantity: "400", unit: "g" } },
    { id: 2, name: "Avocado", image: "http://localhost:3845/assets/avocado.png", RecipeIngredient: { quantity: "3",   unit: null } },
